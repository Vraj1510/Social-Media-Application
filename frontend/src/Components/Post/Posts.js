                  ...
                  <div className='flex flex-row space-x-4 items-center -mt-1 text-white'>
                    ...
                    <div>
                      <div
                        ...
                        className='flex h-8 w-8 mt-3 pb-2 justify-center items-center cursor-pointer'
                      >
                        <img src={edit1} className='h-6 w-6 rounded-md cursor-pointer' />
                      </div>

                      {edit === idx && (
                        <div className='fixed inset-0 flex justify-center items-center z-50 backdrop-filter backdrop-blur-sm bg-black bg-opacity-50'>
                          <div className='fixed flex flex-col bg-stone-100 border-2 p-3 w-[95%] sm:w-[98%] md:w-[99%] lg:w-[77%] lg:min-w-[1050px] rounded-lg z-50'>
                            <img
                              src={remove}
                              onClick={() => {
                                console.log('Reaching here');
