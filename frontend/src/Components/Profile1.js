        ...
        >
          ...
          {(index < 2 || isLargeScreen) && (
            <div className='flex flex-col w-full items-center lg:-ml-0 md:ml-9 lg:h-[46rem] md:h-auto md:w-full overflow-y-scroll lg:w-8/12'>
              <div className='flex flex-row items-top space-x-8 lg:-ml-8 md:-ml-20'>
                {!isSmallScreen && (
                  <img
                ...
                <div className='flex flex-col items-top'>
                        ...
                        {isSmallScreen && (
                          ...
                          >
                            <button
                              ...
                              className='text-cyan-950 w-24 h-10 border-2 border-sky-300 bg-orange-100 text-lg rounded-lg md:mt-6 lg:mt-6'
                            >
                              Unfollow
                            </button>
                            {follower1 && (
                              <button
                                ...
                                className='text-cyan-950 w-32 h-16 border-2 border-sky-300 bg-orange-100 text-lg rounded-lg md:mt-6 lg:mt-6'
                              >
                  ...
                  <div className='flex flex-row md:space-x-6 space-x-16 md:-ml-0 lg:-ml-0 ml-1 lg:space-x-8 -mt-1.5 md:mt-3 lg:mt-3'>
